...
export const metadata: Metadata = {
  ...
  description: "A high-fidelity learning dashboard with animated Bento grid layout, real-time course tracking, and contribution graphs. Built with Next.js 15, Supabase, Tailwind CSS, and Framer Motion.",
